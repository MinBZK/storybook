...
- **Markeer optionele velden, niet verplichte.** Label alleen wat optioneel is (bijv. met "(optioneel)"), niet wat verplicht is met een asterisk. Een formulier hoort zo klein mogelijk te zijn, dus optionele velden zouden in de minderheid moeten zijn — en dan is het efficiënter om die uitzonderingen te markeren dan de regel.
