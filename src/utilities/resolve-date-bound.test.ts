...
describe('resolveDateBound', () => {
	...
	// Een kapot attribuut mag geen formulier blokkeren, dus het telt als geen grens.
	it.each([
		['2026-02-31'],
		['2026-13-01'],
		['31-12-2026'],
	...
	// Zonder klemmen levert 31 maart min een maand stilzwijgend 3 maart op.
	...
	// De leeftijdscontrole waar de relatieve vorm voor bestaat.
