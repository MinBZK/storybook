...
export default {
  ...
  parameters: {
    componentSource: {
      file: 'src/components/layout/split-views/split-view-divider/rr-split-view-divider.ts',
...
export const MetSleepHandvat = () => html`
  <div style="display: flex; flex-direction: row; height: 200px;">
    <div style="flex: 1; background: var(--semantics-surfaces-tinted-background-color);"></div>
    <rr-split-view-divider orientation="vertical" has-drag-handle></rr-split-view-divider>
    <div style="flex: 1; background: var(--semantics-surfaces-tinted-background-color);"></div>
  </div>
`;
