...
describe('ndd-split-view-divider', () => {
	let el: HTMLElement;
	...
	it('renders without error', async () => {
		el = await fixture('<ndd-split-view-divider></ndd-split-view-divider>');
	...
	it('renders drag handle when has-drag-handle is set', async () => {
		el = await fixture('<ndd-split-view-divider has-drag-handle></ndd-split-view-divider>');
		await waitForUpdate(el);
