		...
		<div class="navigation-split-view">
			${component._showSidebar
				? html`
					...
					`
				: nothing}
			${component._showSecondarySidebar
				? html`
			...
			${component._showInspector
				? html`
					...
					`
				: component.inspectorAutoHidden || component.inspectorAsSheet
					? html`
							<dialog
								class="navigation-split-view__inspector-sheet"
						...
						`
					: nothing}
			${component.sidebarAsSheet
				? html`
						<dialog
							class="navigation-split-view__sidebar-sheet"
						...
						>
							<div class="navigation-split-view__sidebar-sheet-body">
								${component._hasSecondarySidebar && component._paneHasContent('secondary-sidebar')
									? html` <slot name="secondary-sidebar"></slot> `
									: html` <slot name="sidebar"></slot> `}
							</div>
						</dialog>
					`
				: nothing}
