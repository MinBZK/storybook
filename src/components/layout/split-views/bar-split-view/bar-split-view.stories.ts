...
export default {
	...
	argTypes: {
		background: {
			...
			description: 'Achtergrondkleur — cascade van --context-parent-background-color naar alle afstammelingen inclusief ndd-page en de fade-overlays',
		...
		<ndd-toolbar>
			...
			>
				...
				>
					...
					<ndd-segmented-control-item value="onderstrepen" text="Onderstrepen" icon="underlined"></ndd-segmented-control-item>
				</ndd-segmented-control>
				<ndd-menu-item
					slot="overflow"
					text="Vet"
			...
			>
				...
				>
					<ndd-segmented-control-item value="none" text="Geen" icon="minus-small"></ndd-segmented-control-item>
					<ndd-segmented-control-item value="bullet" text="Lijst" icon="bullet-list"></ndd-segmented-control-item>
					<ndd-segmented-control-item value="numbered" text="Genummerd" icon="numbered-list"></ndd-segmented-control-item>
				</ndd-segmented-control>
				<ndd-menu-item
					slot="overflow"
					text="Geen"
