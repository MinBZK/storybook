...
export const Grid = () => html`
  <rr-collection layout="grid" show-load-more max-items="6"> ${gridItems} </rr-collection>
`;
Grid.parameters = { controls: { disable: true } };

export const GridLazyLoad = () => html`
  <rr-collection layout="grid" show-load-more max-items="6" lazy-load> ${gridItems} </rr-collection>
`;
GridLazyLoad.parameters = { controls: { disable: true } };

export const Lijst = () => html`
  <rr-collection layout="list" show-load-more max-items="6"> ${listItems} </rr-collection>
`;
Lijst.parameters = { controls: { disable: true } };

export const HorizontaalScrollend = () => html`
  <rr-collection layout="horizontal-scroll"> ${scrollItems} </rr-collection>
`;
