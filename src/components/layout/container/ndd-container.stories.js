...
export default {
	...
	argTypes: {
		...
		paddingInline: {
			...
			description: 'Padding for left and right',
		},
		paddingBlock: {
			control: 'select',
			options: [
			...
			description: 'Padding for top and bottom',
		},
		paddingTop: {
			control: 'select',
			options: [
		...
		paddingBottom: {
			...
			description: 'Padding for bottom',
		},
		paddingLeft: {
			control: 'select',
			options: [
		...
		smPadding: {
			...
			description: 'Padding for all sides at sm viewport',
		},
		smPaddingInline: {
			control: 'select',
			options: [
			...
			description: 'Padding for left and right at sm viewport',
		},
		smPaddingBlock: {
			control: 'select',
			options: [
			...
			description: 'Padding for top and bottom at sm viewport',
		},
		smPaddingTop: {
			control: 'select',
			options: [
			...
			description: 'Padding for top at sm viewport',
		},
		smPaddingRight: {
			control: 'select',
			options: [
			...
			description: 'Padding for right at sm viewport',
		},
		smPaddingBottom: {
			control: 'select',
			options: [
			...
			description: 'Padding for bottom at sm viewport',
		},
		smPaddingLeft: {
			control: 'select',
			options: [
			...
			description: 'Padding for left at sm viewport',
		},
		mdPadding: {
			control: 'select',
			options: [
			...
			description: 'Padding for all sides at md viewport',
		},
		mdPaddingInline: {
			control: 'select',
			options: [
			...
			description: 'Padding for left and right at md viewport',
		},
		mdPaddingBlock: {
			control: 'select',
			options: [
			...
			description: 'Padding for top and bottom at md viewport',
		},
		mdPaddingTop: {
			control: 'select',
			options: [
			...
			description: 'Padding for top at md viewport',
		},
		mdPaddingRight: {
			control: 'select',
			options: [
			...
			description: 'Padding for right at md viewport',
		},
		mdPaddingBottom: {
			control: 'select',
			options: [
			...
			description: 'Padding for bottom at md viewport',
		},
		mdPaddingLeft: {
			control: 'select',
			options: [
			...
			description: 'Padding for left at md viewport',
		},
		lgPadding: {
			control: 'select',
			options: [
			...
			description: 'Padding for all sides at lg viewport',
		},
		lgPaddingInline: {
			control: 'select',
			options: [
			...
			description: 'Padding for left and right at lg viewport',
		},
		lgPaddingBlock: {
			control: 'select',
			options: [
			...
			description: 'Padding for top and bottom at lg viewport',
		},
		lgPaddingTop: {
			control: 'select',
			options: [
			...
			description: 'Padding for top at lg viewport',
		},
		lgPaddingRight: {
			control: 'select',
			options: [
			...
			description: 'Padding for right at lg viewport',
		},
		lgPaddingBottom: {
			control: 'select',
			options: [
			...
			description: 'Padding for bottom at lg viewport',
		},
		lgPaddingLeft: {
			control: 'select',
			options: [
			...
			description: 'Padding for left at lg viewport',
		},
		layoutAreaSmPadding: {
			control: 'select',
			options: [
			...
			description: 'Padding for all sides at sm container size',
		},
		layoutAreaSmPaddingInline: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for left and right at sm container size',
		},
		layoutAreaSmPaddingBlock: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for top and bottom at sm container size',
		},
		layoutAreaSmPaddingTop: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for top at sm container size',
		},
		layoutAreaSmPaddingRight: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for right at sm container size',
		},
		layoutAreaSmPaddingBottom: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for bottom at sm container size',
		},
		layoutAreaSmPaddingLeft: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for left at sm container size',
		},
		layoutAreaMdPadding: {
			control: 'select',
			options: [
			...
			description: 'Padding for all sides at md container size',
		},
		layoutAreaMdPaddingInline: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for left and right at md container size',
		},
		layoutAreaMdPaddingBlock: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for top and bottom at md container size',
		},
		layoutAreaMdPaddingTop: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for top at md container size',
		},
		layoutAreaMdPaddingRight: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for right at md container size',
		},
		layoutAreaMdPaddingBottom: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for bottom at md container size',
		},
		layoutAreaMdPaddingLeft: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for left at md container size',
		},
		layoutAreaLgPadding: {
			control: 'select',
			options: [
			...
			description: 'Padding for all sides at lg container size',
		},
		layoutAreaLgPaddingInline: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for left and right at lg container size',
		},
		layoutAreaLgPaddingBlock: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for top and bottom at lg container size',
		},
		layoutAreaLgPaddingTop: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for top at lg container size',
		},
		layoutAreaLgPaddingRight: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for right at lg container size',
		},
		layoutAreaLgPaddingBottom: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for bottom at lg container size',
		},
		layoutAreaLgPaddingLeft: {
			control: 'select',
			options: [
				'0',
				'2',
			...
			description: 'Padding for left at lg container size',
		},
	},
};
...
export const PaddingContainerQuery = () => html`
	...
	>
		<ndd-rich-text
			><p>
				Responsive container padding: 8 → 16 → 24 → 32 based on layout-area container size.
			</p></ndd-rich-text
		>
	</ndd-container>
`;
