...
export default {
	...
	argTypes: {
		padding: {
			control: 'select',
			options: ['none', 'md', '2', '4', '6', '8', '10', '12', '16', '20', '24', '28', '32', '40', '44', '48', '56', '64', '80', '96'],
...
export const PaddingCombinatie = () => html`
	<rr-container
		...
		style="outline: 1px dashed var(--color-neutral-400);"
	>
		<rr-rich-text><p>padding="16" overschreven door padding-inline="32" voor links en rechts.</p></rr-rich-text>
	</rr-container>
`;
