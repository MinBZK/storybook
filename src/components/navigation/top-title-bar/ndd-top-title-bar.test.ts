...
describe('ndd-top-title-bar', () => {
	...
	it('renders the title', async () => {
		el = await fixture('<ndd-top-title-bar text="Overzicht"></ndd-top-title-bar>');
		await waitForUpdate(el);
	...
	it('renders the supporting text when set', async () => {
		el = await fixture('<ndd-top-title-bar text="Titel" supporting-text="Subtitel"></ndd-top-title-bar>');
		await waitForUpdate(el);
	...
	it('omits the supporting text when not set', async () => {
		el = await fixture('<ndd-top-title-bar text="Titel"></ndd-top-title-bar>');
		await waitForUpdate(el);
...
describe('ndd-top-title-bar – terugknop', () => {
	...
	it('hides the back button when back-text is not set', async () => {
		el = await fixture<NDDTopTitleBar>('<ndd-top-title-bar text="Titel"></ndd-top-title-bar>');
		await waitForUpdate(el);
	...
	it('renders both back button variants when back-text is set', async () => {
		el = await fixture<NDDTopTitleBar>('<ndd-top-title-bar text="Titel" back-text="Overzicht"></ndd-top-title-bar>');
		await waitForUpdate(el);
	...
	it('sets href on back buttons when back-href is set', async () => {
		el = await fixture<NDDTopTitleBar>('<ndd-top-title-bar text="Titel" back-text="Overzicht" back-href="/overzicht"></ndd-top-title-bar>');
		await waitForUpdate(el);
...
describe('ndd-top-title-bar – sluitknop', () => {
	...
	it('shows the dismiss button when dismiss-text is set', async () => {
		el = await fixture<NDDTopTitleBar>('<ndd-top-title-bar text="Titel" dismiss-text="Sluit"></ndd-top-title-bar>');
		await waitForUpdate(el);
		expect(el.shadowRoot!.querySelector('.top-title-bar__dismiss-button')).not.toBeNull();
	});

	it('renders the dismiss text', async () => {
		el = await fixture<NDDTopTitleBar>('<ndd-top-title-bar text="Titel" dismiss-text="Annuleer"></ndd-top-title-bar>');
		await waitForUpdate(el);
...
describe('ndd-top-title-bar – is-compact', () => {
	...
	it('stores the anchor element when collapse-anchor id matches', async () => {
		const container = await fixture<HTMLElement>(`
			<div>
				<ndd-top-title-bar text="Titel" collapse-anchor="heading"></ndd-top-title-bar>
	...
	it('does not set _anchorElement when id does not match', async () => {
		el = await fixture<NDDTopTitleBar>('<ndd-top-title-bar text="Titel" collapse-anchor="does-not-exist"></ndd-top-title-bar>');
		await waitForUpdate(el);
