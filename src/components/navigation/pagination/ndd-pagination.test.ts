...
describe('ndd-pagination – visible page algorithm', () => {
	...
	it('shows all pages when total <= 7', async () => {
		el = await fixture<NDDPagination>(
			'<ndd-pagination current-page="3" total-pages="5"></ndd-pagination>'
		);
		await waitForUpdate(el);
	...
	it('shows exactly 7 when total = 7', async () => {
		el = await fixture<NDDPagination>(
			'<ndd-pagination current-page="4" total-pages="7"></ndd-pagination>'
		);
		await waitForUpdate(el);
	...
	it('near start: shows first 4 + ellipsis + last 2', async () => {
		el = await fixture<NDDPagination>(
			'<ndd-pagination current-page="2" total-pages="10"></ndd-pagination>'
		);
		await waitForUpdate(el);
	...
	it('page 4 transition: shows first 5 + ellipsis + last 1', async () => {
		el = await fixture<NDDPagination>(
			'<ndd-pagination current-page="4" total-pages="10"></ndd-pagination>'
		);
		await waitForUpdate(el);
	...
	it('near end: shows first 1 + ellipsis + last 5', async () => {
		el = await fixture<NDDPagination>(
			'<ndd-pagination current-page="9" total-pages="10"></ndd-pagination>'
		);
		await waitForUpdate(el);
	...
	it('middle: shows first + ellipsis + 3 around current + ellipsis + last', async () => {
		el = await fixture<NDDPagination>(
			'<ndd-pagination current-page="6" total-pages="10"></ndd-pagination>'
		);
		await waitForUpdate(el);
...
describe('ndd-pagination – navigation', () => {
	...
	it('dispatches page-change on page button click', async () => {
		el = await fixture<NDDPagination>(
			'<ndd-pagination current-page="1" total-pages="5"></ndd-pagination>'
		);
		await waitForUpdate(el);
	...
	it('next button is disabled on last page', async () => {
		el = await fixture<NDDPagination>(
			'<ndd-pagination current-page="5" total-pages="5"></ndd-pagination>'
		);
		await waitForUpdate(el);
	...
	it('does not dispatch page-change when clicking current page', async () => {
		el = await fixture<NDDPagination>(
			'<ndd-pagination current-page="2" total-pages="5"></ndd-pagination>'
		);
		await waitForUpdate(el);
