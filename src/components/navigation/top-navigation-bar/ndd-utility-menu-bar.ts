 ...
 * Used as a sub-component of ndd-top-navigation-bar.
 *
 * ## Usage
 * ```html
 * <!-- Default: Language, Search, Account visible -->
 * <ndd-utility-menu-bar></ndd-utility-menu-bar>
 *
 * <!-- Hide default buttons -->
 * <ndd-utility-menu-bar no-language-switch no-account></ndd-utility-menu-bar>
 *
 * <!-- Show optional buttons -->
 * <ndd-utility-menu-bar has-help has-settings></ndd-utility-menu-bar>
 *
 * <!-- Programmatically toggle dropdown state -->
 * <script>
 *   const utilityBar = document.querySelector('ndd-utility-menu-bar');
