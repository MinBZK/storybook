...
const moreIcon = html`<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2">
...
export const Default = () => html`
  <rr-document-tab-bar>
    <rr-document-tab-bar-item selected subtitle="Wet op de Zorgtoeslag"
      >Artikel 2</rr-document-tab-bar-item
    >
    ...
    <rr-icon-button slot="end" variant="neutral-tinted" size="md" label="Meer"
      >${moreIcon}</rr-icon-button
    >
    <rr-icon-button slot="end" variant="neutral-tinted" size="md" label="Nieuw"
