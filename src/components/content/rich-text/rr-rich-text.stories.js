  ...
  render: (args) => html`
    <rr-rich-text spacing=${args.spacing}>
      ...
      <ul>
        ...
        <li>
          <strong>berekeningsjaar:</strong> het kalenderjaar waarover de zorgtoeslag wordt berekend;
        </li>
      </ul>
    </rr-rich-text>
  `,
...
export const Paragraph = {
  ...
  render: (args) => html`
    <rr-rich-text spacing=${args.spacing}>
      ...
      <p>
        De zorgtoeslag wordt berekend op basis van het toetsingsinkomen van de verzekerde en, indien
        van toepassing, diens partner.
      </p>
      <p>
...
export const Blockquote = {
  ...
  render: (args) => html`
    <rr-rich-text spacing=${args.spacing}>
      ...
      <blockquote>
        De zorgtoeslag is bedoeld als tegemoetkoming in de kosten van de zorgverzekering voor mensen
        met een laag inkomen. Het doel is om de toegankelijkheid van de zorg voor iedereen te
        waarborgen, ongeacht de financiële situatie van de verzekerde.
      </blockquote>
...
export const FullArticle = {
  ...
  render: (args) => html`
    <rr-rich-text spacing=${args.spacing}>
      ...
      <p>
        Voor meer informatie verwijzen wij naar de <a href="#">website van de Belastingdienst</a> of
        het <a href="#">Besluit zorgtoeslag</a>.
      </p>
      <figure>
