...
const gripMd = svg`
  <svg class="drag-handle-cell__control-grip" width="10" height="22" viewBox="0 0 10 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const gripSm = svg`
  <svg class="drag-handle-cell__control-grip" width="10" height="16" viewBox="0 0 10 16" fill="none" xmlns="http://www.w3.org/2000/svg">
	<circle cx="2" cy="2"  r="2" fill="currentColor"/>
	<circle cx="8" cy="2"  r="2" fill="currentColor"/>
	<circle cx="2" cy="8"  r="2" fill="currentColor"/>
	<circle cx="8" cy="8"  r="2" fill="currentColor"/>
