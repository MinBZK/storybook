...
describe('ndd-text-cell', () => {
	...
	it('reflects size attribute', async () => {
		el = await fixture('<ndd-text-cell size="sm"></ndd-text-cell>');
		await waitForUpdate(el);
	...
	it('reflects color attribute', async () => {
		el = await fixture('<ndd-text-cell color="secondary"></ndd-text-cell>');
		await waitForUpdate(el);
	...
	it('reflects horizontal-alignment attribute', async () => {
		el = await fixture('<ndd-text-cell horizontal-alignment="right"></ndd-text-cell>');
		await waitForUpdate(el);
	...
	it('reflects vertical-alignment top', async () => {
		el = await fixture('<ndd-text-cell vertical-alignment="top"></ndd-text-cell>');
		await waitForUpdate(el);
		expect(el.getAttribute('vertical-alignment')).toBe('top');
	});

	it('reflects vertical-alignment bottom', async () => {
		el = await fixture('<ndd-text-cell vertical-alignment="bottom"></ndd-text-cell>');
		await waitForUpdate(el);
		expect(el.getAttribute('vertical-alignment')).toBe('bottom');
	});

	it('renders text in shadow DOM', async () => {
		el = await fixture('<ndd-text-cell text="Hallo"></ndd-text-cell>');
		await waitForUpdate(el);
	...
	it('renders overline in shadow DOM', async () => {
		el = await fixture('<ndd-text-cell overline="Overline"></ndd-text-cell>');
		await waitForUpdate(el);
	...
	it('renders supporting-text in shadow DOM', async () => {
		el = await fixture('<ndd-text-cell supporting-text="Supporting"></ndd-text-cell>');
		await waitForUpdate(el);
	...
	it('renders **bold** markers as <b> elements', async () => {
		el = await fixture('<ndd-text-cell text="Hello **world**"></ndd-text-cell>');
		await waitForUpdate(el);
		const p = el.shadowRoot!.querySelector('.text-cell__text');
		expect(p).not.toBeNull();
	...
	it('renders plain text without bold when no ** markers', async () => {
		el = await fixture('<ndd-text-cell text="No bold here"></ndd-text-cell>');
		await waitForUpdate(el);
		const p = el.shadowRoot!.querySelector('.text-cell__text');
		expect(p!.querySelector('b')).toBeNull();
