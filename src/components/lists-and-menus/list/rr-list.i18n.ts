export interface RRListTranslations {
	'components.list.drag-grabbed-text': string;
	'components.list.drag-dropped-text': string;
	'components.list.drag-cancelled-text': string;
	'components.list.drag-position-text': string;
}

export const rrListTranslations: RRListTranslations = {
