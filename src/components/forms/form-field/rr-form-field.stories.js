...
export const Invalid = () => html`
  <rr-form-field label="E-mailadres">
    ...
    <rr-form-field-error-text id="err-email"
      >Voer een geldig e-mailadres in.</rr-form-field-error-text
    >
  </rr-form-field>
`;
...
export const CompleteFormTop = () => html`
  <div style="display: flex; flex-direction: column; gap: 1.5rem;">
    ...
    >
      ...
      ></rr-text-field>
      <rr-form-field-error-text id="err-telefoon"
        >Voer een geldig telefoonnummer in.</rr-form-field-error-text
      >
    </rr-form-field>
    <rr-form-field
      label="Opmerkingen"
...
export const CompleteFormRight = () => html`
  <div style="display: flex; flex-direction: column; gap: 1.5rem; container-type: inline-size;">
    ...
    <rr-form-field label="Telefoonnummer" label-alignment="right" optional>
      ...
      ></rr-text-field>
      <rr-form-field-error-text id="err-telefoon-rechts"
        >Voer een geldig telefoonnummer in.</rr-form-field-error-text
      >
    </rr-form-field>
    <rr-form-field
