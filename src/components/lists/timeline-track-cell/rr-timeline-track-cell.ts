/**
 * RegelRecht Timeline Track Cell Component (Lit + TypeScript)
 *
 ...
 *
 * @element rr-timeline-track-cell
...
@customElement('rr-timeline-track-cell')
export class RRTimelineTrackCell extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'rr-timeline-track-cell': RRTimelineTrackCell;
  }
}
