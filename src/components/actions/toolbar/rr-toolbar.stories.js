...
export const Default = {
  ...
  render: (args) =>
    resizable(html`
      <rr-toolbar size=${args.size} ?show-item-labels=${args.showItemLabels}>
        <rr-toolbar-start-area>
          <rr-toolbar-item label="Vorige/Volgende">
            ...
            <rr-menu-item text="Vorige"></rr-menu-item>
            <rr-menu-item text="Volgende"></rr-menu-item>
          </rr-toolbar-item>
        </rr-toolbar-start-area>
        <rr-toolbar-end-area>
          <rr-toolbar-item label="Opslaan">
            <rr-button variant="primary">Opslaan</rr-button>
            <rr-menu-item text="Opslaan"></rr-menu-item>
          </rr-toolbar-item>
        </rr-toolbar-end-area>
      </rr-toolbar>
    `),
      ...
      <rr-toolbar size=${args.size} ?show-item-labels=${args.showItemLabels}>
        <rr-toolbar-start-area>
          <rr-toolbar-item label="Terug">
            ...
            <rr-menu-item text="Terug"></rr-menu-item>
          </rr-toolbar-item>
        ...
        <rr-toolbar-end-area>
          <rr-toolbar-item label="Annuleren">
            ...
            <rr-menu-item text="Annuleren"></rr-menu-item>
          </rr-toolbar-item>
          <rr-toolbar-item label="Opslaan">
            <rr-button variant="primary">Opslaan</rr-button>
            <rr-menu-item text="Opslaan"></rr-menu-item>
      ...
      <rr-toolbar size=${args.size} ?show-item-labels=${args.showItemLabels}>
        <rr-toolbar-start-area>
          ...
          <rr-toolbar-item label="Dupliceer">
            ...
            <rr-menu-item text="Dupliceer"></rr-menu-item>
          </rr-toolbar-item>
        </rr-toolbar-start-area>
        <rr-toolbar-end-area>
          <rr-toolbar-item label="Opslaan">
  ...
  render: () => html`
    <div style="display: flex; flex-direction: column; gap: 16px;">
      ...
      <div>
        ...
        ${resizable(html`
          <rr-toolbar size="md" show-item-labels>
            <rr-toolbar-start-area>
              <rr-toolbar-item label="Vet">
                <rr-icon-button>
                  <rr-icon name="bold"></rr-icon>
