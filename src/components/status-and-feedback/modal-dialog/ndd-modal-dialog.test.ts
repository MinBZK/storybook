...
describe('ndd-modal-dialog', () => {
	...
	it('forwards text attribute to ndd-inline-dialog', async () => {
	...
	it('forwards supporting-text attribute to ndd-inline-dialog', async () => {
	...
	it('forwards variant attribute to ndd-inline-dialog', async () => {
		el = await fixture('<ndd-modal-dialog variant="alert"></ndd-modal-dialog>');
		await waitForUpdate(el);
		const inner = el.shadowRoot!.querySelector('ndd-inline-dialog');
	...
	it('forwards icon-name attribute to ndd-inline-dialog', async () => {
