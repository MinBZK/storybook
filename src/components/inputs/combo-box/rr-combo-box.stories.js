...
const Template = (args) => html`
  <rr-combo-box placeholder=${args.placeholder} ?disabled=${args.disabled} name=${args.name}>
...
MetZoektermen.parameters = {
  ...
  docs: {
    description: {
      story:
        'Gebruik het <code>search</code> attribuut op <code>rr-menu-item</code> voor alternatieve zoektermen.',
    },
  },
};
