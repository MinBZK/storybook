...
describe('ndd-toggle-button', () => {
	...
	it('renders without error', async () => {
		el = await fixture('<ndd-toggle-button></ndd-toggle-button>');
		await waitForUpdate(el);
		expect(el.shadowRoot).not.toBeNull();
	});

	it('renders a button element by default', async () => {
		el = await fixture('<ndd-toggle-button text="Label"></ndd-toggle-button>');
		await waitForUpdate(el);
	...
	it('type=checkbox renders an input[type=checkbox]', async () => {
		el = await fixture('<ndd-toggle-button type="checkbox" text="Label"></ndd-toggle-button>');
		await waitForUpdate(el);
	...
	it('type=radio renders an input[type=radio]', async () => {
		el = await fixture('<ndd-toggle-button type="radio" text="Label"></ndd-toggle-button>');
		await waitForUpdate(el);
		const input = el.shadowRoot!.querySelector<HTMLInputElement>('input');
		expect(input).not.toBeNull();
	...
	it('renders text from text attribute', async () => {
		el = await fixture('<ndd-toggle-button text="Bewaren"></ndd-toggle-button>');
		await waitForUpdate(el);
	...
	it('renders icon from icon attribute', async () => {
		el = await fixture('<ndd-toggle-button text="Bewaren" icon="heart"></ndd-toggle-button>');
		await waitForUpdate(el);
...
describe('ndd-toggle-button – state', () => {
	...
	it('selected is false by default', async () => {
		el = await fixture<NDDToggleButton>('<ndd-toggle-button></ndd-toggle-button>');
		await waitForUpdate(el);
		expect(el.selected).toBe(false);
	});

	it('selected reflects as attribute', async () => {
		el = await fixture<NDDToggleButton>('<ndd-toggle-button selected></ndd-toggle-button>');
		await waitForUpdate(el);
		expect(el.hasAttribute('selected')).toBe(true);
	});

	it('disabled reflects as attribute', async () => {
		el = await fixture<NDDToggleButton>('<ndd-toggle-button disabled></ndd-toggle-button>');
		await waitForUpdate(el);
		expect(el.hasAttribute('disabled')).toBe(true);
	});

	it('button type: button has aria-pressed=false when not selected', async () => {
		el = await fixture<NDDToggleButton>('<ndd-toggle-button text="Label"></ndd-toggle-button>');
		await waitForUpdate(el);
...
describe('ndd-toggle-button – icon-only', () => {
	let el: NDDToggleButton;
	...
	it('warns when icon-only without accessible-label', async () => {
		...
		el = await fixture<NDDToggleButton>('<ndd-toggle-button icon="heart"></ndd-toggle-button>');
		await waitForUpdate(el);
...
describe('ndd-toggle-button – interaction (button)', () => {
	let el: NDDToggleButton;
...
describe('ndd-toggle-button – interaction (checkbox)', () => {
	let el: NDDToggleButton;
...
describe('ndd-toggle-button – interaction (radio)', () => {
	let el: NDDToggleButton;
...
describe('ndd-toggle-button – toggle()', () => {
	let el: NDDToggleButton;
...
describe('ndd-toggle-button – accessibility', () => {
	let el: NDDToggleButton;
