...
export const TypeButton = () => html`
	<div style="display: flex; flex-direction: column; gap: 0.5rem;">
		<p style="font: var(--primitives-font-body-md-regular-snug); margin: 0;">
			Met <code>type="button"</code> beheert elke knop zijn eigen <code>aria-pressed</code> toestand
			onafhankelijk. Ideaal voor teksteditor-toolbars.
		</p>
...
TypeButton.parameters = {
	...
	docs: {
		description: {
			story:
				'`type="button"` — knoppen zijn onafhankelijk van elkaar en kunnen tegelijk actief zijn. De groep biedt layout en synchronisatie van `size` en `disabled`.',
		},
	},
};
...
export const SingleSelect = () => html`
	<div style="display: flex; flex-direction: column; gap: 0.5rem;">
		<p style="font: var(--primitives-font-body-md-regular-snug); margin: 0;">
			Met <code>type="radio"</code> kan slechts één optie tegelijk geselecteerd zijn. Navigeer met
			de pijltoetsen.
		</p>
...
SingleSelect.parameters = {
	...
	docs: {
		description: {
			story:
				'Single-select met `type="radio"`. Pijltoetsen navigeren tussen opties en selecteren tegelijk.',
		},
	},
};
...
Uitgeschakeld.parameters = {
	...
	docs: {
		description: {
			story:
				'Het `disabled` attribuut op de groep schakelt alle knoppen tegelijk uit. Knoppen die al individueel uitgeschakeld waren, worden niet opnieuw ingeschakeld wanneer de groep weer actief wordt.',
		},
	},
};
...
MetIconen.parameters = {
	...
	docs: {
		description: {
			story:
				'Icoon-only knoppen in een groep. Elk `ndd-toggle-button` heeft een `accessible-label`.',
		},
	},
};
