...
| `nldd-text-editor-mention` | When an @-mention is inserted (detail: MentionInsertedDetail with id, label, from, to; clean offsets, like getSelection()) |
