...
| `no-divider` | — | Suppress dividers adjacent to this bar. Setting it on either side of a seam removes that divider — handy for grouping a toolbar and tab-bar into one visual unit. |
