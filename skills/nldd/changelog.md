...
- **New icons.** Nine icons — `at`, `highlighter`, `strikethrough`, `indent-increase` / `indent-decrease`, `markdown-rectangle`, `rectangle-chevron-left-forward-slash-chevron-right`, `house-and-appartment-building` and `parking-sign-square` — with `indent` / `outdent`, `code-block`, `markdown` and `parking` aliases.
...
- **Icons** — `at`, `highlighter`, `strikethrough`, `indent-increase`, `indent-decrease`, `markdown-rectangle`, `rectangle-chevron-left-forward-slash-chevron-right`, `house-and-appartment-building` and `parking-sign-square`, with `indent` / `outdent`, `code-block`, `markdown` and `parking` aliases.
