...
- **A form section sits 24 pixels from what came before it, not 32.** It carried padding on both sides, and padding collapses with nothing, so it added itself to the 16 the form already puts under the preceding child. It is a top margin now, which does collapse: 16 and 24 beside each other are 24. With the dividers gone there was nothing left for the padding to hold apart anyway.
